    ...
    <div class="header">
      ...
      <div style="display: flex; justify-content: space-between">
        <span style="font-size: 10px; color: rgb(21, 27, 38)"
          >标注审核是指对标注结果进行审核和修正的过程，其目的是确保标注结果的准确性和一致性。</span
        >
      ...
      <div slot="header">
        ...
        <div>
          <span style="font-size: 10px; color: #84868c">
            数据标注平台为一站式数据处理和服务平台，在数据审核模式下项目管理员对已完成的任务进行审核
          </span>
        </div>
      </div>
      <div class="teachbody">
        <div class="teachbodyitem">
          ...
          <div style="text-align: center">
            <div class="itemtitle">选择待审核任务</div>
    ...
    <el-card class="teachcard">
      ...
      <div>
        <el-table :data="createtask" :row-key="getrowkey" :key="update">
                ...
                <el-table :data="scope.row.taskUser" :row-key="getrowkey">
                  ...
                  <el-table-column label="操作">
                    <template slot-scope="scope2">
                      <el-button
                        size="mini"
                        @click="push(scope.row, scope2.row)"
                        >审核</el-button
                      >
                      <el-button
                        size="mini"
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <span size="mini" class="tableplay" @click="push(scope.row)"
                >审核</span
              >
              <span
                size="mini"
