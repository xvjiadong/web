      ...
      <div class="teachbody">
        <div class="teachbodyitem">
          ...
          <div style="text-align: center">
            <div class="itemtitle">选择数据集版本</div>
        ...
        <div class="teachbodyitem">
          ...
          <div style="text-align: center">
            <div class="itemtitle">选择标注团队</div>
            <div class="itemcontent">
        ...
        <div class="teachbodyitem">
          ...
          <div style="text-align: center">
            <div class="itemtitle">标注任务分发</div>
            <div class="itemcontent">
...
export default {
  ...
  methods: {
    ...
    labelupdate() {
      ...
      axios
        .post("http://120.26.142.114:10010/task/label", this.show)
        .then((res) => {
    ...
    handleTasklabel(item) {
      axios
        .get("http://120.26.142.114:10010/task/label/" + item.versionId)
        .then((res) => {
    ...
    handleSchedule(item) {
      this.$router.push({
        path: "/TaskSchedule/",
        query: { id: item.projectId, version: item.versionId },
      });
    },
    getcreatetask() {
