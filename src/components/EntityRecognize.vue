            ...
            <div style="border: 1px solid #eee;height: 585px;display: flex;">
                        ...
                        <div class="mapresult">
                            ...
                            <div v-if="textdata.length > 0">
                                <el-collapse v-model="collapse">
                                    <el-collapse-item v-for="item in label" :key="item.label" :title="item.label"
                                        :name="item.label">
                                        <div v-if="textdata[nowselect].entity[item.label]">
                                            <div style="font-size:18px;display:flex;justify-content:space-between;align-items:center"
                                                v-for="(item2, index) in textdata[nowselect].entity[item.label]"
                                                :key="item + item2 + index">
                                                {{ item2 }}
                                                <i @click="reduce(index, item.label)" style="cursor:pointer"
                ...
                <div class="mapresult2">
                    ...
                    <div
                        ...
                        <div v-for="item in label" :key="item.label" class="labelblock">
...
export default {
    ...
    methods: {
        ...
        reduce(index, label) {
            this.textdata[this.nowselect].entity[label].splice(index, 1)
        },
        save(index) {
            ...
            axios.put("http://120.26.142.114:10010/dataset/call", file, { headers: { "Content-Type": "multipart/form-data;charset=utf-8" } })
                .then((res) => {
