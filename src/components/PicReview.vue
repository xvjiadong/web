                        ...
                        <el-tooltip content="保存" placement="top-end">
                            <div class="toolblock">
                                <el-button type="text" class="el-icon-suitcase button"
                                    @click="together((page - 1) * 5 + nowselect)"></el-button>
                            </div>
                        </el-tooltip>
...
export default {
    ...
    computed: {
        showimage() {
            return this[`imagelist${this.page}`]
        },
    },
    methods: {
        /*切图片时把已标注数据标上 */
        ...
        together(index) {
            ...
            a.forEach(item => {
                ...
                b.forEach(item2 => {
                    if ((typeof item2.id !=="undefined") && item2.id.split("-")[0] === item.id) {
            ...
            this.imagelist1[this.nowselect].access = this.access
            this.shapelist = []
            /*向后端请求前一页或后一页内容*/
            if (index === -1) {
        ...
        ok() {
            ...
            if (this.type === "RECT") {
                ...
                this.tagtextLayer.addText(recttext)
                this.showimage[this.nowselect].mark.push({ type: "RECT", id: this.gFirstFeatureLayer.getAllFeatures()[this.gFirstFeatureLayer.getAllFeatures().length - 1].id, shape: this.data2, text: { text: this.Recognizetextcontent, id: textid } })
                ...
                this.tagtextLayer.addText(polygontext)
                this.showimage[this.nowselect].mark.push({ type: "POLYGON", id: this.gFirstFeatureLayer.getAllFeatures()[this.gFirstFeatureLayer.getAllFeatures().length - 1].id, shape: this.data2, text: { text: this.Recognizetextcontent, id: textid } })
                ...
                const polygontext = new AILabel.Text(textid, { text: this.Recognizetextcontent, position: { x: this.data2[num].x, y: this.data2[num].y }, offset: { x: 1, y: 0 } })
                this.tagtextLayer.addText(polygontext)
                this.showimage[this.nowselect].mark.push({ type: "POLYLINE", id: this.gFirstFeatureLayer.getAllFeatures()[this.gFirstFeatureLayer.getAllFeatures().length - 1].id, shape: this.data2, text: { text: this.Recognizetextcontent, id: textid } })
                ...
                this.tagtextLayer.addText(polygontext)
                this.showimage[this.nowselect].mark.push({ type: "CIRCLE", id: this.gFirstFeatureLayer.getAllFeatures()[this.gFirstFeatureLayer.getAllFeatures().length - 1].id, shape: this.data2, text: { text: this.Recognizetextcontent, id: textid } })
                ...
                this.tagtextLayer.addText(polygontext)
                this.showimage[this.nowselect].mark.push({ type: "POINT", id: this.gFirstFeatureLayer.getAllFeatures()[this.gFirstFeatureLayer.getAllFeatures().length - 1].id, shape: this.data2, text: { text: this.Recognizetextcontent, id: textid } })
                ...
                this.tagtextLayer.addText(polygontext)
                this.showimage[this.nowselect].mark.push({ type: "LINE", id: this.gFirstFeatureLayer.getAllFeatures()[this.gFirstFeatureLayer.getAllFeatures().length - 1].id, shape: this.data2, text: { text: this.Recognizetextcontent, id: textid } })
            }
        ...
        addDeleteIcon(feature, shape) {
            ...
            gFirstMarker.events.on("click", (marker) => {
                ...
                this.showimage[this.nowselect].mark = this.showimage[this.nowselect].mark.filter(item => {
