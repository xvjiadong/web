// 导入js文件
import $ from 'jquery' 
import saveAs from 'file-saver' //引入fileSaver.js
if (typeof $ !== "undefined" && typeof saveAs !== "undefined") {
  (function ($) {
    $.fn.wordExport = function (fileName) {
      ...
      //   mhtmlBottom += "Content-Location: " + images[j].location + "n";
      //   mhtmlBottom += "Content-Type: " + images[j].type + "n";
      //   mhtmlBottom += "Content-Transfer-Encoding: " + images[j].encoding + "nn";
      //   mhtmlBottom += images[j].data + "nn";
      // }
